export const homeObjectA = {
    mainBackground: false,
    mainText: true,
    mainTextDescription: true,
    mainHeader: 'Cheers From Bespoke App',
    headline: 'Cocktail Recipe Refernce Guide For The Avid Drink Enthusiast',
    description: "Remember to always drink responsibly",
    hasButton: false,
    buttonLabel: '',
    img: 'images/nollie_flip.jpg',
    alt: ''
}

export const homeObjectB = {
    mainBackground: false,
    mainText: true,
    mainTextDescription: true,
